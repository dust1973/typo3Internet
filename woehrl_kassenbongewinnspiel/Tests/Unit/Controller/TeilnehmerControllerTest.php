<?php
namespace WOEHRL\WoehrlKassenbongewinnspiel\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class WOEHRL\WoehrlKassenbongewinnspiel\Controller\TeilnehmerController.
 *
...
class TeilnehmerControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \WOEHRL\WoehrlKassenbongewinnspiel\Controller\TeilnehmerController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('WOEHRL\\WoehrlKassenbongewinnspiel\\Controller\\TeilnehmerController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllTeilnehmersFromRepositoryAndAssignsThemToView() {
		...
		$teilnehmerRepository = $this->getMock('WOEHRL\\WoehrlKassenbongewinnspiel\\Domain\\Repository\\TeilnehmerRepository', array('findAll'), array(), '', FALSE);
	...
	public function showActionAssignsTheGivenTeilnehmerToView() {
		$teilnehmer = new \WOEHRL\WoehrlKassenbongewinnspiel\Domain\Model\Teilnehmer();
	...
	public function createActionAddsTheGivenTeilnehmerToTeilnehmerRepository() {
		...
		$teilnehmerRepository = $this->getMock('WOEHRL\\WoehrlKassenbongewinnspiel\\Domain\\Repository\\TeilnehmerRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenTeilnehmerInTeilnehmerRepository() {
		...
		$teilnehmerRepository = $this->getMock('WOEHRL\\WoehrlKassenbongewinnspiel\\Domain\\Repository\\TeilnehmerRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenTeilnehmerFromTeilnehmerRepository() {
		...
		$teilnehmerRepository = $this->getMock('WOEHRL\\WoehrlKassenbongewinnspiel\\Domain\\Repository\\TeilnehmerRepository', array('remove'), array(), '', FALSE);
