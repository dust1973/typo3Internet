...
/**
 * Test case for class Woehrl\WoehrlMarkenverwaltung\Controller\CategoryController.
 *
...
class CategoryControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \Woehrl\WoehrlMarkenverwaltung\Controller\CategoryController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('Woehrl\\WoehrlMarkenverwaltung\\Controller\\CategoryController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllCategoriesFromRepositoryAndAssignsThemToView() {
		...
		$categoryRepository = $this->getMock('Woehrl\\WoehrlMarkenverwaltung\\Domain\\Repository\\CategoryRepository', array('findAll'), array(), '', FALSE);
	...
	public function createActionAddsTheGivenCategoryToCategoryRepository() {
		...
		$categoryRepository = $this->getMock('Woehrl\\WoehrlMarkenverwaltung\\Domain\\Repository\\CategoryRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenCategoryInCategoryRepository() {
		...
		$categoryRepository = $this->getMock('Woehrl\\WoehrlMarkenverwaltung\\Domain\\Repository\\CategoryRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenCategoryFromCategoryRepository() {
		...
		$categoryRepository = $this->getMock('Woehrl\\WoehrlMarkenverwaltung\\Domain\\Repository\\CategoryRepository', array('remove'), array(), '', FALSE);
