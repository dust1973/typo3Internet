 ...
 *
 */
class NachnameValidator extends \TYPO3\CMS\Extbase\Validation\Validator\AbstractValidator {
    ...
    public function isValid($value)
    {
        ...
        if( strlen($value) < 2 ) {
            $this->addError(
                'Um Sie persönlich ansprechen zu können, benötigen wir Ihre Nachname.',
                1806198601,
