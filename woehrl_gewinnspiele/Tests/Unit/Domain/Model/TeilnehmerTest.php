...
/**
 * Test case for class \WOEHRL\WoehrlGewinnspiele\Domain\Model\Teilnehmer.
 *
...
class TeilnehmerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \WOEHRL\WoehrlGewinnspiele\Domain\Model\Teilnehmer
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \WOEHRL\WoehrlGewinnspiele\Domain\Model\Teilnehmer();
	}
